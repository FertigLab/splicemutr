...
comparison_juncs_file <- "/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/run_12072021/ZAPPA/comparison_juncs.rds"
...
if (comparison %in% names(comparison_juncs)){
