...
out_txt<-sprintf("%s/%s_%s%s",out_dir,str_remove_all(basename(splicemutr_data_file),".rds"),"cp_corrected",".txt")
out_rds <- sprintf("%s/%s_%s%s",out_dir,str_remove_all(basename(splicemutr_data_file),".rds"),"cp_corrected",".rds")
