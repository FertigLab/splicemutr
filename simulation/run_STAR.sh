...
#SBATCH --mem=50G
#SBATCH --output /users/tpalmer/neosplice_example/align_peptides/star_run.o
#SBATCH --error /users/tpalmer/neosplice_example/align_peptides/star_run.e
...
FASTAFILES=/dcs04/fertig/data/theron/splicemutr_paper/simulated_reads/fasta_files.txt
...
OUT_DIR=/dcs04/fertig/data/theron/splicemutr_paper/simulated_reads/bams
mkdir -p $OUT_DIR
OUT_DIR=$OUT_DIR/$FILENAME

THREADS=10

REFERENCE=/dcs04/fertig/data/theron/references/GRCh38.gencode.v39/STAR_GRCh38.gencode.v39
