...
Comparisons Progressive Disease:
a) NIV3.NAIVE(PR) vs NIV3.NAIVE(PD)  
b) NIV3.NAIVE(CR) vs NIV3.NAIVE(PD)  
c) NIV3.NAIVE(SD) vs NIV3.NAIVE(PD)  
d) NIV3.PROG(PR) vs NIV3.PROG(PD)  
...
## NIV3.NAIVE(PD) vs NIV3.NAIVE(PR)  
...
## NIV3.NAIVE (PD) vs NIV3.NAIVE (CR)
```{r}
...
## NIV3.NAIVE(PD) vs NIV3.NAIVE(SD)
```{r}
...
saveRDS(comparisons,file="/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/comparisons_PD.rds")
...
leafcutter_files <- read.table("/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/progressive_disease/filenames.txt")
...
for (i in seq(1,total_juncs,10000)){
  ...
  saveRDS(comparison_juncs_small,
          sprintf("/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/progressive_disease/comparison_juncs_linear_PD_%d.rds",iter))
  iter<-iter+1
}


saveRDS(comparison_juncs_linear,file="/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/progressive_disease/comparison_juncs_linear_PD.rds")
saveRDS(comparison_junctions,file="/media/theron/My_Passport/Valsamo/analysis/leafcutterMD/progressive_disease/comparison_juncs_PD.rds")
