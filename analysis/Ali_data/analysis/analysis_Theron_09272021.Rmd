...
C1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C1_pVals.txt"
...
C2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C2_pVals.txt"
...
C3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C3_pVals.txt"
...
C5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C5_pVals.txt"
...
C6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C6_pVals.txt"
...
C7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C7_pVals.txt"
...
P1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P1_pVals.txt"
...
P2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P2_pVals.txt"
...
P3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P3_pVals.txt"
...
P5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P5_pVals.txt"
...
P6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P6_pVals.txt"
...
P7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P7_pVals.txt"
...
C1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C1_perind.counts.gz"
C1_clusters <- read.table(C1_clusters_file,header=T)
...
C2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C2_perind.counts.gz"
C2_clusters <- read.table(C2_clusters_file,header=T)
...
C3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C3_perind.counts.gz"
C3_clusters <- read.table(C3_clusters_file,header=T)
...
C5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C5_perind.counts.gz"
C5_clusters <- read.table(C5_clusters_file,header=T)
...
C6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C6_perind.counts.gz"
C6_clusters <- read.table(C6_clusters_file,header=T)
...
C7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C7_perind.counts.gz"
C7_clusters <- read.table(C7_clusters_file,header=T)
...
P1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P1_perind.counts.gz"
P1_clusters <- read.table(P1_clusters_file,header=T)
...
P2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P2_perind.counts.gz"
P2_clusters <- read.table(P2_clusters_file,header=T)
...
P3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P3_perind.counts.gz"
P3_clusters <- read.table(P3_clusters_file,header=T)
...
P5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P5_perind.counts.gz"
P5_clusters <- read.table(P5_clusters_file,header=T)
...
P6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P6_perind.counts.gz"
P6_clusters <- read.table(P6_clusters_file,header=T)
...
P7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P7_perind.counts.gz"
P7_clusters <- read.table(P7_clusters_file,header=T)
...
write.table(all_sample_psi,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_psi.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
write.table(all_sample_pvals,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_pval.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
...
write.table(juncs_sig_df,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_sig.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
saveRDS(juncs_sig_df,
        file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_sig.rds")
...
write.table(juncs_all_df,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_all.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
...
C1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C1P_perind.counts.gz"
C1_clusters <- read.table(C1_clusters_file,header=T)
rownames(C1_clusters) <- C1_clusters$chrom
C1_clusters$juncs <- vapply(rownames(C1_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C2P_perind.counts.gz"
C2_clusters <- read.table(C2_clusters_file,header=T)
rownames(C2_clusters) <- C2_clusters$chrom
C2_clusters$juncs <- vapply(rownames(C2_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C3P_perind.counts.gz"
C3_clusters <- read.table(C3_clusters_file,header=T)
rownames(C3_clusters) <- C3_clusters$chrom
C3_clusters$juncs <- vapply(rownames(C3_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C5P_perind.counts.gz"
C5_clusters <- read.table(C5_clusters_file,header=T)
rownames(C5_clusters) <- C5_clusters$chrom
C5_clusters$juncs <- vapply(rownames(C5_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C6P_perind.counts.gz"
C6_clusters <- read.table(C6_clusters_file,header=T)
rownames(C6_clusters) <- C6_clusters$chrom
C6_clusters$juncs <- vapply(rownames(C6_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C7P_perind.counts.gz"
C7_clusters <- read.table(C7_clusters_file,header=T)
rownames(C7_clusters) <- C7_clusters$chrom
C7_clusters$juncs <- vapply(rownames(C7_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P1_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P1C_perind.counts.gz"
P1_clusters <- read.table(P1_clusters_file,header=T)
rownames(P1_clusters) <- P1_clusters$chrom
P1_clusters$juncs <- vapply(rownames(P1_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P2_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P2C_perind.counts.gz"
P2_clusters <- read.table(P2_clusters_file,header=T)
rownames(P2_clusters) <- P2_clusters$chrom
P2_clusters$juncs <- vapply(rownames(P2_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P3_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P3C_perind.counts.gz"
P3_clusters <- read.table(P3_clusters_file,header=T)
rownames(P3_clusters) <- P3_clusters$chrom
P3_clusters$juncs <- vapply(rownames(P3_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P5_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P5C_perind.counts.gz"
P5_clusters <- read.table(P5_clusters_file,header=T)
rownames(P5_clusters) <- P5_clusters$chrom
P5_clusters$juncs <- vapply(rownames(P5_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P6_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P6C_perind.counts.gz"
P6_clusters <- read.table(P6_clusters_file,header=T)
rownames(P6_clusters) <- P6_clusters$chrom
P6_clusters$juncs <- vapply(rownames(P6_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
P7_clusters_file <- "/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P7C_perind.counts.gz"
P7_clusters <- read.table(P7_clusters_file,header=T)
rownames(P7_clusters) <- P7_clusters$chrom
P7_clusters$juncs <- vapply(rownames(P7_clusters),function(val){
  all_info <- strsplit(val,":")[[1]]
...
C1_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C1.junc",sep="\t")
...
C2_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C2.junc",sep="\t")
...
C3_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C3.junc",sep="\t")
...
C5_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C5.junc",sep="\t")
...
C6_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C6.junc",sep="\t")
...
C7_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/C7.junc",sep="\t")
...
P1_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P1.junc",sep="\t")
...
P2_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P2.junc",sep="\t")
...
P3_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P3.junc",sep="\t")
...
P5_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P5.junc",sep="\t")
...
P6_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P6.junc",sep="\t")
...
P7_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/P7.junc",sep="\t")
...
U1_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/U1.junc",sep="\t")
...
U2_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/U2.junc",sep="\t")
...
U3_juncs <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/U3.junc",sep="\t")
...
write.table(all_sample_psi,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_psi_CP_PC.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
write.table(all_sample_pvals,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_pval_CP_PC.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
write.table(all_sample_counts_norm,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_counts_norm_CP_PC.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
...
write.table(juncs_sig_df,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_sig_CP_PC.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
saveRDS(juncs_sig_df,
        file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_sig_CP_PC.rds")

juncs_all_df <- data.frame(matrix(unlist(strsplit(juncs_all,":")),nrow=length(juncs_all),ncol=4,byrow=T))
colnames(juncs_all_df)<-c("chrom","start","end","strand")

write.table(juncs_all_df,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/juncs_all_CP_PC.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
...
write.table(ali_maf_dat_muts,
            file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/ali_maf_muts.txt",
            sep="\t",
            quote=F,
            col.names=T,
            row.names=F)
saveRDS(ali_maf_dat_muts,file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/ali_maf_muts.rds")
...
out_fasta<-"/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/ali_maf_muts.fa"
writeXStringSet(sequences,out_fasta)
saveRDS(tx_name,file="/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/tx_names.rds")
...
for (i in seq(length(breaks))){
  if (i == length(breaks)){
    ...
    out_fasta<-sprintf("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/ali_maf_muts_%d.fa",i)
...
RSEM_small <- RSEM_refseq_complete[,seq(3,ncol(RSEM_refseq_complete)-2)]
RSEM_scale <- t(apply(RSEM_small,1,scale))
colnames(RSEM_scale)<-colnames(RSEM_small)
RSEM_scale<-RSEM_scale[apply(RSEM_small,1,sd) != 0,]
col_labs <- data.frame(vapply(colnames(RSEM_scale),function(val){
  if (str_detect(val,"TPM_C")){
    return("Combo")
  } else if (str_detect(val,"TPM_P")){
    return("PD1")
  } else {
    return("Untreated")
  }
},character(1)))
colnames(col_labs)<-"Arm"
rownames(col_labs)<-colnames(RSEM_scale)
pheatmap(RSEM_scale,show_rownames=F,annotation_col = col_labs, cluster_cols=F)
pheatmap(RSEM_scale,show_rownames=F,annotation_col = col_labs, cluster_cols=T)

RSEM_small <- RSEM_refseq_average[,seq(3)]
colnames(RSEM_small)<-c("Combo","PD1","Untreated")
pheatmap(RSEM_small,show_rownames=F, cluster_cols=F)
...
all_sample_psi<-read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_psi_CP_PC.txt",header=T)
all_sample_pvals <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_pval_CP_PC.txt",header=T)
all_sample_counts_norm <- read.table("/media/theron/My_Passport/Ali_data/analysis/star_to_leaf_juncs/all_sample_counts_norm_CP_PC.txt",header=T)
...
Heatmap(scale(prot_imm_dat_all),
