...
#$ -o /users/tpalmer/TCGA/running_mhcnuggets/mhc_run.o
#$ -e /users/tpalmer/TCGA/running_mhcnuggets/mhc_run.e
#$ -M tpalme15@jhmi.edu
#$ -m ea
#$ -t 1-16 -tc 16
...
TYPE="I"
INPUT_KMERS=$TCGA_ROOT_DIR/$TCGA_CANCER/process_peptides_out/peps_9.txt
MHC_ALLELE_FILE=$TCGA_ROOT_DIR/$TCGA_CANCER/${TCGA_CANCER}_class1_alleles.txt
