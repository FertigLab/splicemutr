...
L1_loss <- readRDS("/media/theron/My_Passport/TCGA_junctions/TCGA_cancers/mut_sig_types_L1.rds")
L2_loss <- readRDS("/media/theron/My_Passport/TCGA_junctions/TCGA_cancers/mut_sig_types_L2.rds")
apobec <- c("T[C>T]A","T[C>T]T","T[C>G]A","T[C>G]T")
mut_sig_perc_sum <- data.frame(apply(mut_sig_perc[,apobec],1,sum))
colnames(mut_sig_perc_sum)<-"apobec_prop"
mut_sig_perc_sum$sample_ID <- vapply(TCGAbarcode(rownames(mut_sig_perc_sum),sample=T),function(sample){
...
for (i in seq(nrow(tumor_data))){
  ...
  splice_mut_per_sample$apobec_prop <- vapply(splice_mut_per_sample$sample,function(samp){
    a<-which(mut_sig_perc_sum$sample_ID == samp)
    if (length(a)==0){
      return(-1)
    } else {
      return(mut_sig_perc_sum[a,"apobec_prop"])
    }
  },numeric(1))
  ...
  cluster_metrics_tum[cluster_metrics_tum$cancers==cancer,"apobec_prop"] <- median(splice_mut_per_sample$apobec_prop)
...
ggplot(cluster_metrics_tum,aes(x=log10(splice_imm_av+1),y=apobec_prop,label=cancers))+
  geom_text()+
  stat_cor(method = "spearman",
           label.x.npc = "center",
           label.y.npc = "top")+
...
splice_mut_per_sample_all_apo <- splice_mut_per_sample_all %>% dplyr::filter(apobec_prop>=0)

ggplot(splice_mut_per_sample_all_apo,aes(x=splice_mut_av,y=apobec_prop))+
  geom_point()+
  stat_cor(method = "spearman",
           label.x.npc = "center",
           label.y.npc = "top")+
...
ggplot(splice_mut_per_sample_all_apo,aes(x=splice_mut_med,y=apobec_prop))+
  geom_point()+
  stat_cor(method = "spearman",
           label.x.npc = "center",
           label.y.npc = "top")+
...
ggplot(splice_mut_per_sample_all_apo,aes(x=log10(splice_mut_max),y=apobec_prop))+
  geom_point()+
  stat_cor(method = "spearman",
           label.x.npc = "center",
           label.y.npc = "top")+
...
ggplot(cluster_metrics_tum,aes(x=log10(splice_imm_med+1),y=apobec_prop,label=cancers))+
  geom_text()+
  stat_cor(method = "spearman",
           label.x.npc = "center",
           label.y.npc = "top")+
...
a<-cor.test(cibersort_data_filt$B.cells.naive,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$B.cells.naive,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$B.cells.naive,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$B.cells.memory,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$B.cells.memory,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$B.cells.memory,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Plasma.cells,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Plasma.cells,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Plasma.cells,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD8,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD8,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD8,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.naive,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.naive,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.naive,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.resting,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.resting,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.resting,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.activated,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.activated,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.CD4.memory.activated,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.follicular.helper,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.follicular.helper,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.follicular.helper,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.regulatory..Tregs.,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.regulatory..Tregs.,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.regulatory..Tregs.,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.gamma.delta,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.gamma.delta,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$T.cells.gamma.delta,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.resting,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.resting,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.resting,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.activated,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.activated,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$NK.cells.activated,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Monocytes,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Monocytes,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Monocytes,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M0,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M0,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M0,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M1,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M1,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M1,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M2,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M2,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Macrophages.M2,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.resting,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.resting,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.resting,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.activated,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.activated,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Dendritic.cells.activated,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.resting,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.resting,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.resting,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.activated,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.activated,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Mast.cells.activated,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Eosinophils,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Eosinophils,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Eosinophils,cibersort_data_filt$splice_mut_med,method="spearman")
...
a<-cor.test(cibersort_data_filt$Neutrophils,cibersort_data_filt$TMB,method="spearman")
...
a<-cor.test(cibersort_data_filt$Neutrophils,cibersort_data_filt$splice_mut_av,method="spearman")
...
a<-cor.test(cibersort_data_filt$Neutrophils,cibersort_data_filt$splice_mut_med,method="spearman")
