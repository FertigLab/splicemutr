...
for (i in seq(nrow(tumor_data))){
  ...
  tumor_geno_file <- sprintf("%s/%s_genotypes.txt",tumor_dir,cancer)
  tumor_geno <- read.table(tumor_geno_file,header=T)
  splice_mut_file <- sprintf("%s/%s_splice_dat_clusters_filt_ann_max.rds",tumor_dir,cancer)
  splice_mut_data <- readRDS(splice_mut_file)
  colnames(splice_mut_data) <- vapply(colnames(splice_mut_data),function(col_name){
    col_name<-str_replace(col_name,"X","")
    col_name <- str_replace_all(col_name,"[.]","-")
...
for (i in seq(nrow(tumor_data))){
  ...
  tumor_geno_file <- sprintf("%s/%s_genotypes.txt",tumor_dir,cancer)
  tumor_geno <- read.table(tumor_geno_file,header=T)
  splice_mut_file <- sprintf("%s/%s_splice_dat_clusters_filt_ann_median.rds",tumor_dir,cancer)
  splice_mut_data <- readRDS(splice_mut_file)
  colnames(splice_mut_data) <- vapply(colnames(splice_mut_data),function(col_name){
    col_name<-str_replace(col_name,"X","")
    col_name <- str_replace_all(col_name,"[.]","-")
...
for (i in seq(nrow(tumor_data))){
  ...
  tumor_geno_file <- sprintf("%s/%s_genotypes.txt",tumor_dir,cancer)
  tumor_geno <- read.table(tumor_geno_file,header=T)
  splice_mut_file <- sprintf("%s/%s_splice_dat_clusters_filt_max.rds",tumor_dir,cancer)
  splice_mut_data <- readRDS(splice_mut_file)
  colnames(splice_mut_data) <- vapply(colnames(splice_mut_data),function(col_name){
    col_name<-str_replace(col_name,"X","")
    col_name <- str_replace_all(col_name,"[.]","-")
...
for (i in seq(nrow(tumor_data))){
  ...
  tumor_geno_file <- sprintf("%s/%s_genotypes.txt",tumor_dir,cancer)
  tumor_geno <- read.table(tumor_geno_file,header=T)
  splice_mut_file <- sprintf("%s/%s_splice_dat_clusters_filt_median.rds",tumor_dir,cancer)
  splice_mut_data <- readRDS(splice_mut_file)
  colnames(splice_mut_data) <- vapply(colnames(splice_mut_data),function(col_name){
    col_name<-str_replace(col_name,"X","")
    col_name <- str_replace_all(col_name,"[.]","-")
